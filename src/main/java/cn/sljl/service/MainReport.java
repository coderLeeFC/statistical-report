...
public class MainReport {
    ...
    private void getPgzx(Connection connection, XSSFWorkbook workbook, XSSFSheet sheet, DateUtils dateUtils, CommonSql commonSql, DeptUtils deptUtils) throws SQLException {
        ...
        //期末应收账款
        //1.应收账款-开票（期初）
        double[] beginOfLastYear = deptUtils.pgzxDebit(Constant.SDSJ_DEPT_INCOME.get(4),connection, commonSql, dateUtils.getStartOfLastYear(Constant.THIS_MONTH_END), dateUtils.getStartOfLastYear(Constant.THIS_MONTH_END),Constant.ACCOUNTING_BOOK.get(0),Constant.ACCOUNTING_BOOK.get(3),Constant.ACCOUNTS_RECEIVABLE,Constant.ACCOUNTS_RECEIVABLE_INVOICING);
        double[] beginOfThisYear = deptUtils.pgzxDebit(Constant.SDSJ_DEPT_INCOME.get(4),connection, commonSql, dateUtils.getStartOfYear(Constant.THIS_MONTH_END),     dateUtils.getStartOfYear(Constant.THIS_MONTH_END),    Constant.ACCOUNTING_BOOK.get(0),Constant.ACCOUNTING_BOOK.get(3),Constant.ACCOUNTS_RECEIVABLE,Constant.ACCOUNTS_RECEIVABLE_INVOICING);

        //2.应收账款-开票（借方累计）
        double[] beginOfThisYearThisMonthDebit = deptUtils.pgzxDebit(Constant.SDSJ_DEPT_INCOME.get(4),connection, commonSql, dateUtils.getBeginningOfYear(Constant.THIS_MONTH_END) , dateUtils.getLastMonthEnd(Constant.THIS_MONTH_END), Constant.ACCOUNTING_BOOK.get(0),Constant.ACCOUNTING_BOOK.get(3),Constant.ACCOUNTS_RECEIVABLE,Constant.ACCOUNTS_RECEIVABLE_INVOICING);
        double[] endOfThisYearThisMonthDebit   = deptUtils.pgzxDebit(Constant.SDSJ_DEPT_INCOME.get(4),connection, commonSql, dateUtils.getBeginningOfYear(Constant.THIS_MONTH_END) , Constant.THIS_MONTH_END,                            Constant.ACCOUNTING_BOOK.get(0),Constant.ACCOUNTING_BOOK.get(3),Constant.ACCOUNTS_RECEIVABLE,Constant.ACCOUNTS_RECEIVABLE_INVOICING);
        double[] beginOfLastYearThisMonthDebit = deptUtils.pgzxDebit(Constant.SDSJ_DEPT_INCOME.get(4),connection, commonSql, dateUtils.getBeginningOfYear1(Constant.THIS_MONTH_END), dateUtils.getLastMonthEnd1(Constant.THIS_MONTH_END),Constant.ACCOUNTING_BOOK.get(0),Constant.ACCOUNTING_BOOK.get(3),Constant.ACCOUNTS_RECEIVABLE,Constant.ACCOUNTS_RECEIVABLE_INVOICING);
        double[] endOfLastYearThisMonthDebit   = deptUtils.pgzxDebit(Constant.SDSJ_DEPT_INCOME.get(4),connection, commonSql, dateUtils.getBeginningOfYear1(Constant.THIS_MONTH_END), dateUtils.getEndOfMonth(Constant.THIS_MONTH_END),   Constant.ACCOUNTING_BOOK.get(0),Constant.ACCOUNTING_BOOK.get(3),Constant.ACCOUNTS_RECEIVABLE,Constant.ACCOUNTS_RECEIVABLE_INVOICING);

        //3.应收账款-开票（贷方累计）
        double[] beginOfThisYearThisMonthCredit = deptUtils.pgzxCredit(Constant.SDSJ_DEPT_INCOME.get(4),connection, commonSql,  dateUtils.getBeginningOfYear(Constant.THIS_MONTH_END) , dateUtils.getLastMonthEnd(Constant.THIS_MONTH_END), Constant.ACCOUNTING_BOOK.get(0),Constant.ACCOUNTING_BOOK.get(3),Constant.ACCOUNTS_RECEIVABLE,Constant.ACCOUNTS_RECEIVABLE_INVOICING);
        double[] endOfThisYearThisMonthCredit   = deptUtils.pgzxCredit(Constant.SDSJ_DEPT_INCOME.get(4),connection, commonSql,  dateUtils.getBeginningOfYear(Constant.THIS_MONTH_END) , Constant.THIS_MONTH_END,                            Constant.ACCOUNTING_BOOK.get(0),Constant.ACCOUNTING_BOOK.get(3),Constant.ACCOUNTS_RECEIVABLE,Constant.ACCOUNTS_RECEIVABLE_INVOICING);
        double[] beginOfLastYearThisMonthCredit = deptUtils.pgzxCredit(Constant.SDSJ_DEPT_INCOME.get(4),connection, commonSql,  dateUtils.getBeginningOfYear1(Constant.THIS_MONTH_END), dateUtils.getLastMonthEnd1(Constant.THIS_MONTH_END),Constant.ACCOUNTING_BOOK.get(0),Constant.ACCOUNTING_BOOK.get(3),Constant.ACCOUNTS_RECEIVABLE,Constant.ACCOUNTS_RECEIVABLE_INVOICING);
        double[] endOfLastYearThisMonthCredit   = deptUtils.pgzxCredit(Constant.SDSJ_DEPT_INCOME.get(4),connection, commonSql,  dateUtils.getBeginningOfYear1(Constant.THIS_MONTH_END), dateUtils.getEndOfMonth(Constant.THIS_MONTH_END),   Constant.ACCOUNTING_BOOK.get(0),Constant.ACCOUNTING_BOOK.get(3),Constant.ACCOUNTS_RECEIVABLE,Constant.ACCOUNTS_RECEIVABLE_INVOICING);
        ...
        //期末合同资产
        //1.应收账款-暂估（期初）
        double[] beginOfLastYear1 = deptUtils.pgzxDebit(Constant.SDSJ_DEPT_INCOME.get(4),connection, commonSql, dateUtils.getStartOfLastYear(Constant.THIS_MONTH_END), dateUtils.getStartOfLastYear(Constant.THIS_MONTH_END),Constant.ACCOUNTING_BOOK.get(0),Constant.ACCOUNTING_BOOK.get(3),Constant.ACCOUNTS_RECEIVABLE,Constant.ACCOUNTS_RECEIVABLE_ESTIMATED);
        double[] beginOfThisYear1 = deptUtils.pgzxDebit(Constant.SDSJ_DEPT_INCOME.get(4),connection, commonSql, dateUtils.getStartOfYear(Constant.THIS_MONTH_END),     dateUtils.getStartOfYear(Constant.THIS_MONTH_END),    Constant.ACCOUNTING_BOOK.get(0),Constant.ACCOUNTING_BOOK.get(3),Constant.ACCOUNTS_RECEIVABLE,Constant.ACCOUNTS_RECEIVABLE_ESTIMATED);

        //2.应收账款-暂估（借方累计）
        double[] beginOfThisYearThisMonthDebit1 = deptUtils.pgzxDebit(Constant.SDSJ_DEPT_INCOME.get(4),connection, commonSql, dateUtils.getBeginningOfYear(Constant.THIS_MONTH_END) , dateUtils.getLastMonthEnd(Constant.THIS_MONTH_END), Constant.ACCOUNTING_BOOK.get(0),Constant.ACCOUNTING_BOOK.get(3),Constant.ACCOUNTS_RECEIVABLE,Constant.ACCOUNTS_RECEIVABLE_ESTIMATED);
        double[] endOfThisYearThisMonthDebit1   = deptUtils.pgzxDebit(Constant.SDSJ_DEPT_INCOME.get(4),connection, commonSql, dateUtils.getBeginningOfYear(Constant.THIS_MONTH_END) , Constant.THIS_MONTH_END,                            Constant.ACCOUNTING_BOOK.get(0),Constant.ACCOUNTING_BOOK.get(3),Constant.ACCOUNTS_RECEIVABLE,Constant.ACCOUNTS_RECEIVABLE_ESTIMATED);
        double[] beginOfLastYearThisMonthDebit1 = deptUtils.pgzxDebit(Constant.SDSJ_DEPT_INCOME.get(4),connection, commonSql, dateUtils.getBeginningOfYear1(Constant.THIS_MONTH_END), dateUtils.getLastMonthEnd1(Constant.THIS_MONTH_END),Constant.ACCOUNTING_BOOK.get(0),Constant.ACCOUNTING_BOOK.get(3),Constant.ACCOUNTS_RECEIVABLE,Constant.ACCOUNTS_RECEIVABLE_ESTIMATED);
        double[] endOfLastYearThisMonthDebit1   = deptUtils.pgzxDebit(Constant.SDSJ_DEPT_INCOME.get(4),connection, commonSql, dateUtils.getBeginningOfYear1(Constant.THIS_MONTH_END), dateUtils.getEndOfMonth(Constant.THIS_MONTH_END),   Constant.ACCOUNTING_BOOK.get(0),Constant.ACCOUNTING_BOOK.get(3),Constant.ACCOUNTS_RECEIVABLE,Constant.ACCOUNTS_RECEIVABLE_ESTIMATED);

        //3.应收账款-暂估（贷方累计）
        double[] beginOfThisYearThisMonthCredit1 = deptUtils.pgzxCredit(Constant.SDSJ_DEPT_INCOME.get(4),connection, commonSql, dateUtils.getBeginningOfYear(Constant.THIS_MONTH_END) , dateUtils.getLastMonthEnd(Constant.THIS_MONTH_END), Constant.ACCOUNTING_BOOK.get(0),Constant.ACCOUNTING_BOOK.get(3),Constant.ACCOUNTS_RECEIVABLE,Constant.ACCOUNTS_RECEIVABLE_ESTIMATED);
        double[] endOfThisYearThisMonthCredit1   = deptUtils.pgzxCredit(Constant.SDSJ_DEPT_INCOME.get(4),connection, commonSql, dateUtils.getBeginningOfYear(Constant.THIS_MONTH_END) , Constant.THIS_MONTH_END,                            Constant.ACCOUNTING_BOOK.get(0),Constant.ACCOUNTING_BOOK.get(3),Constant.ACCOUNTS_RECEIVABLE,Constant.ACCOUNTS_RECEIVABLE_ESTIMATED);
        double[] beginOfLastYearThisMonthCredit1 = deptUtils.pgzxCredit(Constant.SDSJ_DEPT_INCOME.get(4),connection, commonSql, dateUtils.getBeginningOfYear1(Constant.THIS_MONTH_END), dateUtils.getLastMonthEnd1(Constant.THIS_MONTH_END),Constant.ACCOUNTING_BOOK.get(0),Constant.ACCOUNTING_BOOK.get(3),Constant.ACCOUNTS_RECEIVABLE,Constant.ACCOUNTS_RECEIVABLE_ESTIMATED);
        double[] endOfLastYearThisMonthCredit1   = deptUtils.pgzxCredit(Constant.SDSJ_DEPT_INCOME.get(4),connection, commonSql, dateUtils.getBeginningOfYear1(Constant.THIS_MONTH_END), dateUtils.getEndOfMonth(Constant.THIS_MONTH_END),   Constant.ACCOUNTING_BOOK.get(0),Constant.ACCOUNTING_BOOK.get(3),Constant.ACCOUNTS_RECEIVABLE,Constant.ACCOUNTS_RECEIVABLE_ESTIMATED);
